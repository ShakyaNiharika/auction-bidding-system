            ...
            <div className="w-full md:w-1/2 p-8 md:p-14 flex flex-col justify-center text-center">
                ...
                <form onSubmit={handleSubmit} className="space-y-3 max-w-sm mx-auto w-full text-left">
                    ...
                    <button
                        ...
                        className="w-full py-2.5 rounded-full border border-gray-300 flex items-center justify-center gap-3 hover:bg-gray-50 transition-colors relative font-medium text-slate-700"
                    >
                        {/* Google Icon */}
