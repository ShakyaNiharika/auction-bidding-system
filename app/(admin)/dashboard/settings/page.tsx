        ...
        <div className="space-y-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                {sections.map((section, i) => (
                    <button key={i} className="flex items-start gap-6 p-8 bg-white rounded-[32px] border border-gray-100 shadow-sm hover:shadow-xl hover:border-[#1b4332]/20 transition-all text-left">
            ...
            <div className="bg-[#1b4332]/5 p-8 rounded-[32px] border border-[#1b4332]/10 flex flex-col md:flex-row justify-between items-center gap-6">
                <div className="space-y-1">
                    <h3 className="text-lg font-bold text-[#1b4332]">Advanced Control</h3>
                    <p className="text-sm text-[#1b4332]/80 font-medium">Reset your API keys or delete your seller account.</p>
                </div>
                <button className="px-8 py-3 bg-white text-[#1b4332] rounded-2xl text-sm font-black shadow-sm hover:bg-[#1b4332] hover:text-white transition-all">
                    System Console
                </button>
            </div>
        </div>
